      ...
      <div className="flex justify-between text-wrap">
        {card.map((item) => {
          return (
            <div
              key={item.id}
              className="border border-neutral-200 hover:border-green-600 hover:shadow-lg hover:shadow-green-50 rounded-sm flex flex-col items-center p-6"
            >
              <img src={item.image} alt="Vegetables" className="pb-2 h-20" />
